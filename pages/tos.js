...
const lastUpdated = "April 19, 2021";
  ...
  return (
    <Layout>
      <div className={styles.longParagraph}>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to ThymeKeep.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to ThymeKeep, accessible from{" "}
              <Link href="/">https://thymekeep.com</Link>
            </p>
          </li>
          <li>
            <p>
        ...
        <ul>
          <li>By email: thunderchime@gmail.com</li>
        </ul>
      </div>
    </Layout>
  );
